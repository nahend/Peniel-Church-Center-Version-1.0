  ...
  return (
    <Shell>
      ...
      <div className="mt-8 grid gap-4 lg:grid-cols-[1fr_1fr]">
        <GlassCard><h2 className="text-2xl font-medium">Operations</h2><p className="mt-3 text-slate-300">Role-secured tools for managing media, validation, workflow transitions, and audit history.</p></GlassCard>
